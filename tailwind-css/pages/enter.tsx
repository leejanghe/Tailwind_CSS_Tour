    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid pb-4 grid-cols-2 mt-8 gap-16 border-b w-full">
          <button
              className={cls(
        ...
        <form className="flex flex-col mt-8">
          ...
          <div className="mt-1">
            {method === "email" ? <input id="input" type="email" className="appearance-none w-full px-3 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500" required /> : null}
            {method === "phone" ? (
          ...
          <button className="mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rouned-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
