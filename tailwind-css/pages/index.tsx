...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 xl:place-content-center py-20 px-10 grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
      ...
      <div className="portrait:bg-indigo-600 landscape:bg-teal-500 bg-blue-500 p-6 pb-14 xl:pb-40">
